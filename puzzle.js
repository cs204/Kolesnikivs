...
знания2.добавить(new Эквивалентность(new И(АРыцарь, БЛжец), БРыцарь))
...
знания3.добавить(new Эквивалентность(БРыцарь, new Не(АРыцарь)))
знания3.добавить(new Эквивалентность(БРыцарь, new Не(ВРыцарь)))
знания3.добавить(new Эквивалентность(ВРыцарь, new Не(АЛжец)))
знания3.добавить(new Эквивалентность(ВРыцарь, new Не(АЛжец)))
